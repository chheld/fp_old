package com.support.android.designlibdemo.model.Auftrag;
...
public class Auftrag_ok implements Parcelable {
    ...
    public Auftrag_ok(String a) {
        super();
        this.ANR = a;
    }

    protected Auftrag_ok(Parcel in) {
    ...
    public static final Creator<Auftrag_ok> CREATOR = new Creator<Auftrag_ok>() {
        @Override
        public Auftrag_ok createFromParcel(Parcel in) {
            return new Auftrag_ok(in);
        }

        @Override
        public Auftrag_ok[] newArray(int size) {
            return new Auftrag_ok[size];
        }
    };
    ...
    public Auftrag_ok loadOrderDataByANR (Context c, String search) {
