...
public class Kontakt_ok implements Parcelable {
     ...
     * The PERSONNR
     */
    public Kontakt_ok(String a) {
        super();
        this.PERSONNR = a;
    }

    protected Kontakt_ok(Parcel in) {
        IK = in.readString();
        SYSF = in.readString();
    ...
    public static final Creator<Kontakt_ok> CREATOR = new Creator<Kontakt_ok>() {
        @Override
        public Kontakt_ok createFromParcel(Parcel in) {
            return new Kontakt_ok(in);
        }

        @Override
        public Kontakt_ok[] newArray(int size) {
            return new Kontakt_ok[size];
        }
    };
